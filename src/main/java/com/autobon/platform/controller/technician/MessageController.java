 ...
 */
@RestController("technicianMessageController")
@RequestMapping("/api/mobile/technician/message")
public class MessageController {
    ...
    public JsonMessage list(@RequestParam(value = "page", defaultValue = "1") int page,
        ...
        return new JsonMessage(true, "", "", new JsonPage<>(messageService.find(1, 1, page, pageSize)));
    }
}
