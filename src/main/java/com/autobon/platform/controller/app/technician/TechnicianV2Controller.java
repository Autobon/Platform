...
//            in.close();
    ...
    public JsonResult getOrder(@PathVariable("orderId") int orderId,
        ...
        if(order.getMainTechId() != null) orderView.setComment(commentService.getByOrderIdAndTechId(orderId, order.getMainTechId()));
...
//    }
    ...
    @RequestMapping(value = "/v2/order/finish", method = RequestMethod.POST)
    @ResponseBody
