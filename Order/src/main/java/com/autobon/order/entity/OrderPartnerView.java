...
@Entity
@Table(name="t_order_partner_view")
public class OrderPartnerView{
    ...
    public Integer getPartnerTechId() {
        return partnerTechId;
    }

    public void setPartnerTechId(Integer partnerTechId) {
        this.partnerTechId = partnerTechId;
    }
}
