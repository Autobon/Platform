CREATE TABLE `t_construction` (
  ...
  `before_photos` varchar(255) DEFAULT NULL COMMENT '施工前照片数组,用逗号隔开',
  `after_photos` varchar(255) DEFAULT NULL COMMENT '施工后照片数组,用逗号隔开',
  `payment` float(8,2) DEFAULT NULL COMMENT '结算金额',
  `work_items` varchar(100) DEFAULT NULL COMMENT '工作项（多项用逗号隔开）;或工作占比, 用小数表示, 如0.2',
