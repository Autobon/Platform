CREATE VIEW t_order_partner_view as  SELECT   o.id ,
                                                                       o.order_num,
                                                                       o.photo,
                                                                       o.agreed_start_time  ,
                                                                       o.agreed_end_time,
                                                                       ...
                                                                       FROM
                                                                       t_order o
                                                                        INNER JOIN t_work_detail wd ON wd.order_id = o.id and wd.tech_id != o.main_tech_id
